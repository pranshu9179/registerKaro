...
//       <div
//         className="relative flex flex-col md:flex-row items-center justify-between min-h-screen bg-cover bg-center px-6 md:px-10"
...
//               <div className="flex flex-wrap items-center space-x-4 text-yellow-500">
...
//             <button className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700">
//               Talk An Expert
//             </button>
...
//         <div className="flex-col space-y-4 mt-6 md:mt-0 md:absolute md:top-1/4 md:right-10 hidden md:flex">
//           {[
//             "Annual Compliance",
//             "Payroll Services",
//             "Company Formation",
...
//             src={oracleLogo}
//             alt="Oracle"
//             className="h-12 md:h-16 lg:h-20 transition-transform hover:scale-110"
//           />
//           <img
//             src={morpheusLogo}
//             alt="Morpheus"
...
const Home = () => {
  return (
    <div className="relative">
      <div
        className="relative flex flex-col md:flex-row items-center justify-between min-h-screen bg-cover bg-center px-6 sm:px-8 md:px-10"
        style={{ backgroundImage: `url(${myImage})` }}
      >
        <div className="w-full md:w-1/2 text-left">
          ...
          <div className="flex items-center mt-6 space-x-4">
            <div className="w-full flex flex-wrap items-center space-x-4 text-yellow-500">
              <div className="flex items-center space-x-1">
                ⭐⭐⭐⭐⭐ <span className="text-gray-900">Google Rating</span>
              </div>
        ...
        <div className="flex-col space-y-4 mt-6 md:mt-0 md:absolute md:top-1/4 md:right-10 hidden md:flex">
          {[
            ...
            <button
              key={index}
              className="w-64 px-6 py-3 bg-white shadow-md rounded-lg text-gray-900 font-semibold text-center border border-gray-300
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8 md:hidden">
          {[
            ...
            <button
              key={index}
              className="w-full max-w-xs px-6 py-3 bg-white shadow-md rounded-lg text-gray-900 font-semibold text-center border 
